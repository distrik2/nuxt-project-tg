<template>
  <div class="course-container">
    <h1>Курс 2: Основы кибербезопасности</h1>
    <p>
      Этот курс предназначен для будущих программистов по кибербезопасности.
    </p>
...
export default {
  setup() {
    const topics = ref<Topic[]>([
      {
        title: "Часть 1",
        videoUrl: "https://www.youtube.com/live/_HcACxBsBLg?si=8E633aBjozQlLXdW",
        completed: false,
      },
      {
        title: "Часть 2",
        videoUrl: "https://www.youtube.com/live/Gv1mBpruoEc?si=LBX7z1Uy68DSEDwa",
        completed: false,
      },
      {
        title: "Часть 3",
        videoUrl: "https://www.youtube.com/live/9vOJjsL-fMw?si=c74f2oIcS3gymy7m",
        completed: false,
      },
    ]);
