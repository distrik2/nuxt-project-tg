<template>
  <div class="course-container">
    <h1>Курс 3: ООП Python</h1>
    <p>
      Узнаем о ООП в этом курсе.
    </p>
    ...
    const topics = ref<Topic[]>([
      {
        ...
        videoUrl: "https://youtu.be/P4CNNo8jWj4?si=_C7_5URZ-8TyLRu6",
        completed: false,
      },
      {
        title: "Методы классов",
        videoUrl: "https://youtu.be/Lw8TeLS4_IA?si=bs_WuvdUvebw5lKV",
        completed: false,
      },
      {
        title: "Инициализатор __init__ и финализатор __del__ ",
        videoUrl: "https://youtu.be/-J3Ou8-8vVk?si=bqg3zo68JjGWo6MM",
        completed: false,
      },
    ]);
